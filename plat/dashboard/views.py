...
def create_lecture(request):
    ...
    if request.method == 'POST':
        ...
        for x in students:
            ...
            create_lecture_object = StudentLectureObject.objects.create(lecture_id=new_lecture.id , user=student_user , user_name=student_user.username , title=new_lecture.title , image=new_lecture.image , price=new_lecture.price , duration=new_lecture.duration , purchased=False , object=True)
...
def add_student(request):
    ...
    if request.method == 'POST':
        ...
        user_lecture_object = StudentLectureObject.objects.get(user=user_profile.user , lecture_id=lecture.id)
        user_lecture_object.purchased = True
        user_lecture_object.save()


        user_purchase_object = BuyLesson.objects.create(lecture_id=lecture.id , lecture_title=lecture.title, lecture_value=lecture.price , user=user , user_name=user_profile.name , user_image=user_profile.image , method='admin' )
